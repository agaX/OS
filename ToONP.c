    ...
    switch(fork ()) {
        ...
        default:
            ...
            for (int i = 0; i < strlen(argv[1]); i++)
              if (write (pipe_dsc[0][1], &argv[1][i], sizeof(char)) == -1) syserr("ToONP, write(pipe_dsc[1][0])");
	    ...
	    /*char c = '#';
            ...
            //c = ' ';
            //while (c != '#') {
            //  if (read (pipe_dsc[1][0], &c, sizeof(char)) == -1) syserr("ToONP, read(pipe_dsc[0][1])");
            //  printf("%c", c);
           // }
           ...
           // if(write (1, converted, sizeof(converted)) == -1) syserr("ToONP, write(1, converted, sizeof(converted))");
